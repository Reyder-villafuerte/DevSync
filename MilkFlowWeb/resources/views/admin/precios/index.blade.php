                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="price_milk_base" value="{{ old('price_milk_base', $currentPrice->price_milk_base) }}" required class="w-full pl-8 pr-3 py-2.5 rounded-xl border border-slate-200 text-xs font-bold bg-slate-50/50 focus:bg-white">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2.5 text-xs text-slate-400 font-bold">S/</span>
                                <input type="number" step="0.01" name="price_milk_water_penalty_low" value="{{ old('price_milk_water_penalty_low', $currentPrice->price_milk_water_penalty_low) }}" required class="w-full pl-8 pr-3 py-2.5 rounded-xl border border-amber-200 text-xs font-bold bg-amber-50/30 focus:bg-white">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2.5 text-xs text-slate-400 font-bold">S/</span>
                                <input type="number" step="0.01" name="price_milk_water_penalty_high" value="{{ old('price_milk_water_penalty_high', $currentPrice->price_milk_water_penalty_high) }}" required class="w-full pl-8 pr-3 py-2.5 rounded-xl border border-rose-200 text-xs font-bold bg-rose-50/30 focus:bg-white">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-2 border-t border-slate-100">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2.5 text-xs text-slate-400 font-bold">S/</span>
                                <input type="number" step="0.01" name="price_cheese_provider" value="{{ old('price_cheese_provider', $currentPrice->price_cheese_provider) }}" required class="w-full pl-8 pr-3 py-2.5 rounded-xl border border-slate-200 text-xs font-bold bg-slate-50/50 focus:bg-white">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2.5 text-xs text-slate-400 font-bold">S/</span>
                                <input type="number" step="0.01" name="price_cheese_wholesale" value="{{ old('price_cheese_wholesale', $currentPrice->price_cheese_wholesale) }}" required class="w-full pl-8 pr-3 py-2.5 rounded-xl border border-slate-200 text-xs font-bold bg-slate-50/50 focus:bg-white">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2.5 text-xs text-slate-400 font-bold">S/</span>
                                <input type="number" step="0.01" name="price_cheese_local" value="{{ old('price_cheese_local', $currentPrice->price_cheese_local) }}" required class="w-full pl-8 pr-3 py-2.5 rounded-xl border border-slate-200 text-xs font-bold bg-slate-50/50 focus:bg-white">
                            </div>
                        </div>
                    </div>
                </div>
