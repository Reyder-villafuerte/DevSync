...
<head>
    ...
    <title>Ayni Huata - @yield('title', 'Panel del día')</title>
...
<body class="h-full bg-spark-surface text-slate-800 antialiased flex">
    ...
    <aside id="huataMenu" tabindex="-1" aria-label="Menú principal" class="huata-sidebar offcanvas-lg offcanvas-start w-64 bg-spark-dark text-slate-300 flex-shrink-0 flex flex-col justify-between p-4 no-print border-r border-emerald-950/40">
        <div>
            <div class="huata-brand"><img src="{{ asset('brand/huata-simbolo-vaca.png') }}" alt="Ecolácteos Huata" width="86" height="86"><span>Ayni Huata<br><small>Hecho para nuestra comunidad</small></span><button type="button" class="btn-close d-lg-none" data-bs-dismiss="offcanvas" data-bs-target="#huataMenu" aria-label="Cerrar menú"></button></div>
            ...
            <nav class="space-y-6 text-xs font-semibold">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        {{-- La jornada de acopio es la pantalla de trabajo del acopiador.
                             La jefatura ya ve el reparto del día en Zonas, así que no le
                             ocupa una entrada del menú. --}}
                        @if(Auth::user()->role === 'acopiador')
                        <li>
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        ...
                        @if(in_array(Auth::user()->role, ['jefe_produccion', 'admin', 'jefe_general']))
                        <li>
                            <a href="{{ route('produccion.categorias.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('produccion.categorias.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                                <i class="fa-solid fa-tags text-sm"></i>
                                <span>Categorías y Unidades</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('produccion.almacen.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('produccion.almacen.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                                <i class="fa-solid fa-boxes-stacked text-sm"></i>
                                <span>Almacén e Insumos</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('produccion.compras.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('produccion.compras.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                        ...
                        <li>
                            <a href="{{ route('produccion.productos.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('produccion.productos.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                                <i class="fa-solid fa-flask text-sm"></i>
                                <span>Productos y Recetas</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('produccion.lotes.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('produccion.lotes.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('admin.usuarios.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('admin.usuarios.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.roles.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('admin.roles.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.catalogo.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('admin.catalogo.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.tipos-cliente.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('admin.tipos-cliente.*') ? 'bg-spark-lime text-spark-dark font-bold shadow-sm' : 'hover:bg-white/5 hover:text-white text-slate-400' }}">
